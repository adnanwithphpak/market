...
export const post = {
  title: 'High DA Guest Posts: What Matters More Than DA',
  ...
  metaTitle: 'High DA Guest Posts Explained',
  metaDescription: 'DA is not everything. Learn what matters more than DA when buying guest posts and backlinks.',
  content: (
    <div className="space-y-6 text-slate-700 leading-relaxed">
      <h1 className="text-4xl font-bold text-slate-900 mb-6">High DA Guest Posts: What Matters More Than DA</h1>
